...
$mail->Subject = 'New Bike Hire Confirmation Stage';
$mail->Body = ' ';
$mail->Body .= "<div id='Cinfo'><h1>Contact Details for this order</h1><p>Name:$Name</p><p>Email:$Email</p><p>Mobile:$mobile</p></div>";
